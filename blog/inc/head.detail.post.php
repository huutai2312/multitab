...
<body class="post-template-default single single-post postid-105 single-format-standard">
  ...
  <div class="spide-fn-wrapper core_ready">
                    ...
                    <div class="menu-main-menu-container">
                      <ul id="menu-main-menu" class="spide_fn_main_nav">
                        ...
                        <!-- <li id="menu-item-118" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-118">
                          <a href="#"><span><span>Danh mục</span></span></a>
                          <ul class="sub-menu">
                            <li id="menu-item-236" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-236">
                              <a href="https://frenify.com/work/envato/frenify/wp/spide/1/category/travel/"><span><span>Travel</span></span></a>
                            </li>
                          </ul>
                        </li> -->
    ...
    <!-- !Header -->
    <div class="spide_fn_stickynav ajax_enable active" bis_skin_checked="1">
      <div class="container" bis_skin_checked="1">
        <div class="transform_hedaer" bis_skin_checked="1">
          <div class="sticky_header" bis_skin_checked="1">
            <div class="spide_fn_nav sticky_nav" bis_skin_checked="1">
              <div class="menu" bis_skin_checked="1">
                <div class="menu-main-menu-container" bis_skin_checked="1">
                  <ul id="menu-main-menu" class="spide_fn_main_nav">
                    <li id="menu-item-205" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current_page_ancestor menu-item-205">
                      <a href="javascript:history.go(-1)"><span><span>
                            < Quay lại</span>
              ...
              <div class="icon_bar" bis_skin_checked="1">
                <div class="icon_bar__item icon_bar__share" bis_skin_checked="1">
                  <a href="#" aria-label="Share"><svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="428.000000pt" height="470.000000pt" viewbox="0 0 428.000000 470.000000" preserveaspectratio="xMidYMid meet" class="fn__svg replaced-svg">
                  ...
                  <div class="spide_fn_social_list" bis_skin_checked="1">
                    <ul>
                      <li>
                        <a title="facebook" href="https://www.facebook.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="512.000000pt" height="512.000000pt" viewbox="0 0 512.000000 512.000000" preserveaspectratio="xMidYMid meet" class="fn__svg replaced-svg">
                      ...
                      <li>
                        <a title="instagram" href="https://www.instagram.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="512.000000pt" height="512.000000pt" viewbox="0 0 512.000000 512.000000" preserveaspectratio="xMidYMid meet" class="fn__svg replaced-svg">
                            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
          ...
          <div class="header_post_reading" bis_skin_checked="1">
            <div class="" bis_skin_checked="1">
              <h3>
                <span class="title" style="font-size: 22px">MENU</span>
              </h3>
            </div>
          </div>
        </div>
    ...
    <div class="spide_fn_mobnav">
      <div class="mob_top">
        <div class="logo">
          <div class="fn_logo">
            <a href="https://frenify.com/work/envato/frenify/wp/spide/1/" aria-label="Go to home page"><img class="mobile_logo" src="https://frenify.com/work/envato/frenify/wp/spide/1/wp-content/themes/spide/framework/img/logo/mobile-logo.png" alt="logo" /><img class="mobile_retina_logo" src="https://frenify.com/work/envato/frenify/wp/spide/1/wp-content/themes/spide/framework/img/logo/mobile-retina-logo.png" alt="logo" /></a>
          </div>
        </div>
        <div class="right__triggerr">
          <a class="mobmenu_opener" href="#" aria-label="Open Mobile Menu Navigation"></a>
        </div>
      </div>
      <div class="mob_bot">
        <div class="spide_fn_social_list">
