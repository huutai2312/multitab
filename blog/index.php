          ...
          <div class="container">
            <div class="fn__page_layout">
              <div class="fn__bp_slider">
                <div class="bp_slider_in">
                    ...
                    if (isset($sbl1)) {
                      if ($sbl1 && $sbl1->num_rows > 0) {
                        ...
                        while ($result = $sbl1->fetch_assoc()) {
                          if ($result['hot'] === 'y' && $result['showhide'] === 'show') {
                    ?>
                            <div class="item">
                              <div class="img_wrap">
                                <div class="img_holder">
                                  <a href="post.php?url=<?php echo $result['slug']; ?>">
                                    <div class="abs_img" data-bg-img="<?php echo 'data:image/png;base64,' . base64_encode($result['img']); ?>"></div>
                                  </a>
                                </div>
                              </div>
                              <div class="title_holder">
                                ...
                                <div class="title_in">
                                  <h3><a href="post.php?url=<?php echo $result['slug']; ?>"><?php echo $result['title'] ?></a></h3>
                                  <div class="metass">
                                    <span class="meta__date"><span class="text"><?php echo $result['date'] ?></span></span><span class="meta__author"><?php echo $result['author'] ?></span>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="slider__nav">
                    <a href="#" class="slider_nav prev"><img class="fn__svg" src="https://frenify.com/work/envato/frenify/wp/spide/1/wp-content/themes/spide/framework/svg/arrow2.svg" alt="svg"></a><a href="#" class="slider_nav next"><img class="fn__svg" src="https://frenify.com/work/envato/frenify/wp/spide/1/wp-content/themes/spide/framework/svg/arrow2.svg" alt="svg"></a>
                  </div>
                </div>
              </div>
              ...
              <ul class="fn__blog_list fn__blog_list_container_full fn__blog_list_layout_masonry">
                <!-- == Tin thường == -->
                <?php
                // foreach ($sbl as $result) {
                //   // Kiểm tra điều kiện để chỉ hiển thị "Tin thường"
                //   if ($result['showhide'] === 'show' && $result['hot'] === 'n') {
                if (isset($sbl)) {
                  if ($sbl && $sbl->num_rows > 0) {
                    $i = 0;
                    while ($result = $sbl->fetch_assoc()) {
                      if ($result['hot'] === 'n' && $result['showhide'] === 'show') {
                ?>
